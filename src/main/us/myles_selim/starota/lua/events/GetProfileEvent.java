...
public class GetProfileEvent extends LuaEvent {
	...
	public LuaValue toLua(LuaState state) {
		...
		// ConversionHandler.convertToLua(state,
		// this.getServer().getDiscordGuild()));
		//
		...
		// ExtraField field = new ExtraField(arg1.toString(), arg2.toString(),
		// arg3.checkBoolean());
		// fields.add(field);
		...
		// throw new LuaError("arg1 must be a number between 1 and " +
		// (fields.size() - 1));
